...
export default function EntradaFinanceiro({navigation}) {
  ...
  function voltar(){
    ...
    const [data,setNewDate]=useState(created_at) ;
     ...
     async function submit(){
        await api.post('/src/all/financeiro/entrada',
        ...
        <View style={{flex:1, justifyContent:"space-between"}}>
            ...
            <ScrollView style={styles.containerScrollView}>
                ...
                >
                    ...
                    <Text style={styles.textdashboard}>Entrada no Financeiro</Text>
                    ...
                    <View style={styles.viewTextDashboard1}>
                        ...
                        <Text style={styles.textdashboard1}>Digite a Origem da Entrada↓↓</Text>
                            <TextInput
                            style={styles.textInput}
                        ...
                        <Text style={styles.textdashboard1}>Digite o Valor da Entrada↓↓</Text>
                            <TextInput
                            style={styles.textInput}
                        ...
                        onPress={submit} 
                        >
                            <Text style={styles.submitText}>Finalizar Entrada</Text>
